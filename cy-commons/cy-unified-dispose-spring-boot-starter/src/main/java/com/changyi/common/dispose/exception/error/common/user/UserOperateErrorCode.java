package com.changyi.common.dispose.exception.error.common.user;
...
public enum UserOperateErrorCode implements IErrorCodeEnum {
    ...
    UNSUPPORTED_MEDIA_TYPE("A0415", String.format("呀，不支持该媒体类型(%s)", HttpStatus.UNSUPPORTED_MEDIA_TYPE.getReasonPhrase())),
     ...
     * 系统限流
     */
    TRAFFIC_LIMITING("A0429", "哎呀，网络拥挤请稍后再试试"),
